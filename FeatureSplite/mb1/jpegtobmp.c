...
int JpegToBmp(char *file1, char *file2)
{
	...
	for (i = 0 ; i < NUM_OF_INIT_BUFF_LOAD ; i++)
	{
    ...
    fi = (unsigned int *)(cmem_input_circ_buff);
#else
...
#else
        hw_dma_send_addr((int*)((shared_pt_REMOTEADDR + i * 4096)),(int*)fpBMP, 4096, (void*)mb1_dma1_BASEADDR);
#endif		
	}
}
