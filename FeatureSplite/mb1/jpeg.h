...
#define INPUT_READ_SIZE_INT   512
#define NUM_OF_INIT_BUFF_LOAD 2
#define INPUT_READ_SIZE       (INPUT_READ_SIZE_INT >> 2) 
#define INPUT_READ_SIZE_BITS  ((INPUT_READ_SIZE << 2) << 3)
#define NUM_OF_BLOCKS         4
#define TOTAL_BLOCK_SIZE      (((INPUT_READ_SIZE<<2) * NUM_OF_BLOCKS) - 1)
