...
int main (void)
{
	...
	*mb2_start = 1; *mb3_start = 1;
	...
	{ 
	   ...
	   /* Demo of Custom Malloc implementation */
	   {
	     int  *aa;
		 char *ch;
	     MY_MK_MALLOC(ch,int,5); //*ch = (int*) mk_malloc(5 *sizeof(int));
	     MY_MK_MALLOC(aa,char,10); //*aa = (char*) mk_malloc(10 * sizeof(char));
